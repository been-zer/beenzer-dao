    ...
    <div class="min-h-[840px] rounded-xl pt-2 pb-4" :class="this.$store.state.dark ? 'bg-gray-800 shadow-gray-700' : 'bg-white'">
      ...
      <div v-if="checkbox">
        ...
        <div class="grid grid-cols-3 gap-1 text-s font-semibold text-center py-4 px-4 rounded-xl">
          <button @click="clickNum(1)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 rounded-tl-xl align-middle relative border">1</button>
          <button @click="clickNum(2)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 align-middle relative border">2</button>
          <button @click="clickNum(3)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 rounded-tr-xl align-middle relative border">3</button>
          <button @click="clickNum(4)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 align-middle relative border">4</button>
          <button @click="clickNum(5)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 align-middle relative border">5</button>
          <button @click="clickNum(6)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 align-middle relative border">6</button>
          <button @click="clickNum(7)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 rounded-bl-xl align-middle relative border">7</button>
          <button @click="clickNum(8)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 align-middle relative border">8</button>
          <button @click="clickNum(9)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 rounded-br-xl align-middle relative border">9</button>
          <button @click="resetNum()"  :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-3 px-2 rounded-3xl m-3 align-middle relative border">↻</button>
          <button @click="clickNum(0)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 rounded-b-xl align-middle relative border">0</button>
          <button @click="deleteNum()" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-green-600' : 'bg-gray-50 hover:bg-green-600'" class="py-3 px-2 rounded-3xl m-3 align-middle relative border border-green-600">⛏️</button>          
        <div/>
      ...
      <div v-else>
        ...
        <div class="grid grid-cols-3 gap-1 text-s font-semibold text-center py-4 px-4 rounded-xl">
          ...
          <button @click="resetNum()"  :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-3 px-2 rounded-3xl m-3 align-middle relative border">↻</button>
          <button @click="clickNum(0)" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-gray-400 border-gray-500' : 'bg-gray-50 hover:bg-gray-200 border-gray-100'" class="py-6 px-2 rounded-b-xl align-middle relative border">0</button>
          <button @click="deleteNum()" :class="this.$store.state.dark ? 'bg-gray-600 hover:bg-red-600' : 'bg-gray-50 hover:bg-red-600'" class="py-3 px-2 rounded-3xl m-3 align-middle relative border border-red-600">🔥</button>          
        <div/>

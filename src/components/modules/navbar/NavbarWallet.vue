...
<header class="px-4 py-4 sm:py-6 px-auto xl:px-12 2xl:px-24 lg:flex justify-between" >
  <div class="flex">
    ...
    <div class="flex flex-wrap justify-between">
      <div class="p-0">
        <a href="beenzer.app" target="_blank" class="flex justify-center align-middle sm:mr-2">
      ...
      <!-- Profile -->
      <div class="text-center font-semibold text-sm ml-4" v-if="store.state.username">
